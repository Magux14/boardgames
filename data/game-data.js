export const lstGames = [
    ...
    {
        name: 'Weapon Wars',
        desc: 'Weapon Wars es un juego de cartas donde retarás en un duelo a muerte a tus amigos, lanza misiles nucleares, utiliza espadas legendarias y rompe las reglas del universo en este adictivo Juego de Cartas.',
        minPlayers: 2,
        maxPlayers: 6,
        difficulty: 2,
    ...
    {
        name: 'Spectrum',
        desc: 'Sumérgete en una experiencia de juego sin igual con Spectrum, el juego de mesa que te transportará a un mundo lleno de emociones y desafíos. A medida que avanzas en el juego, te enfrentarás a desafiantes pruebas con las cartas de acción que usen los demás jugadores y decisiones difíciles que pondrán a prueba tu ingenio y habilidades estratégicas. Se el primero en realizar 2 secuencias de 5 elementos que coincidan en color y forma.',
        minPlayers: 2,
        maxPlayers: 8,
        difficulty: 3,
        img: 'spectrum.webp',
    ...
    {
        name: 'Sheep in Disguise',
        desc: '¡En Sheep in Disguise la diversión está en la astucia! Recolecta ovejas disfrazadas, protégelas de depredadores y sabotea a tus oponentes en este alocado juego de cartas.',
        minPlayers: 2,
        maxPlayers: 6,
        difficulty: 3,
    ...
    },
    {
        ...
        desc: 'Nos pondremos en la piel de intrépidos exploradores que, tras una expedición en busca de tesoros, nos vemos atrapados en una isla que se desmorona bajo nuestros pies. Con criaturas marinas y terrestres al acecho, remolinos, volcanes en erupción, y un número limitado de balsas para escapar. ',
        minPlayers: 2,
        maxPlayers: 5,
        difficulty: 2,
