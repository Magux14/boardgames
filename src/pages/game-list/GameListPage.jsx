...
export const GameListPage = () => {
    ...
    const imageContainerRefs = useRef(new Map());
    ...
    useEffect(() => {
        ...
        imageContainerRefs.current.forEach(el => observer.observe(el));
                    ...
                    <div className="game-list-page__list-container">
                        ...
                        {lstFilteredItems.map(item =>
                            <div key={item.name} className="game-list-page__game">
                                ...
                                <div
                                    className="game-list-page__image-container"
                                    data-bg={`${import.meta.env.VITE_PUBLIC_GITHUB_ORIGIN_PAGE}/img/games/${encodeURIComponent(item.img)}`}
                                    ref={(el) => {
                                        if (el) imageContainerRefs.current.set(item.name, el);
                                        else imageContainerRefs.current.delete(item.name);
                                    }}
                                >
                                    <img
                                        data-src={`${import.meta.env.VITE_PUBLIC_GITHUB_ORIGIN_PAGE}/img/games/${item.img}`}
                                        alt={item.name}
